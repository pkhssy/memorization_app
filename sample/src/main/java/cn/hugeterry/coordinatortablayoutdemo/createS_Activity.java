...
public class createS_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic.setBackgroundResource(R.drawable.gallery);
        ...
        translationBtn.setBackgroundResource(R.drawable.translatebtn);
        ...
        // 카테고리 얻어와야 함.
        addBtn.setBackgroundResource(R.drawable.plusbtn);
        ...
        back.setBackgroundResource(R.drawable.backbtn);
