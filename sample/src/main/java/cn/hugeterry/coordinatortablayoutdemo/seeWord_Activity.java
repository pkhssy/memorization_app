...
public class seeWord_Activity extends AppCompatActivity {
    ...
    private ArrayList<String> spelling, meaning; // 화면에 보일 단어와 뜻
       ...
       // showM = (Button)findViewById(R.id.showMeaning);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentAdd = new Intent(getApplicationContext(),createW_Activity.class); // 단어 추가 페이지로 가기
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(spelling.size() == 0){ // 내용물이 없을 경우 삭제가 안 되도록
                    ...
                    delete_contents(spelling.get(index)); // DB에서 현재 단어 삭제
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 1){
            if(resultCode == Activity.RESULT_OK) { // "추가 완료" 였을 경우
                ...
                mSpelling = mSpelling.replace("'",""); // 따옴표가 있다면, 없애기
                mSpelling = mSpelling.replace("!",""); // ! 가 있다면, 없애기
                mSpelling = mSpelling.replace("?",""); // ? 있다면, 없애기
                mSpelling = mSpelling.replace(".",""); // . 있다면, 없애기
                ...
                if(isUnique(mSpelling)== true){ // 존재 X
                    ...
                    Log.i("Insert Word","Word - Spelling: "+mSpelling+", Meaning: "+mMeaning);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.test: // test 내용 받기 &
                ...
                final Intent testIntent = new Intent(getApplicationContext(),testW_Activity.class);
